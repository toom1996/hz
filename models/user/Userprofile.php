 ...
 *
 * @property Articleclass[] $articleclasses
 * @property Baidusmallprogrammanagement[] $baidusmallprogrammanagements
 * @property Businesscard[] $businesscards
 * @property Clientapplet[] $clientapplets
 * @property Compomentlibrary[] $compomentlibraries
 * @property Compomentlibraryclass[] $compomentlibraryclasses
 * @property Customerofficialnumber[] $customerofficialnumbers
 * @property Form[] $forms
 * @property Invitethechild[] $invitethechildren
 * @property Invitethechild[] $invitethechildren0
 * @property Messageinform[] $messageinforms
 * @property Page[] $pages
 * @property Pagegroup[] $pagegroups
 * @property Permissions[] $permissions
 * @property Photolibrary[] $photolibraries
 * @property Photolibrarygroup[] $photolibrarygroups
 * @property Role[] $roles
 * @property Servicetable[] $servicetables
 * @property Template[] $templates
 * @property Templateclass[] $templateclasses
 * @property Transfer[] $transfers
 * @property Transfer[] $transfers0
 * @property Userprofile $inviter
 * @property Userprofile[] $userprofiles
 * @property Role $role
 */
class Userprofile extends \app\models\BaseModel
{
    /**
     * {@inheritdoc}
     */
