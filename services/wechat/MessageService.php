...
class MessageService extends Service
{
    ...
    public function customer($openid, $type, $data)
    {
        switch ($type) {
            // 文字回复
            case WechatEnum::RULE_MODULE_TEXT :
                $message =  new Text($data);
                break;
            // 图片回复
            case WechatEnum::RULE_MODULE_IMAGE :
                $message = new Image($data);
                break;
            // 图文回复
            case WechatEnum::RULE_MODULE_NEWS :
                ...
                break;
            // 视频回复
            case WechatEnum::RULE_MODULE_VIDEO :
