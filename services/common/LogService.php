...
class LogService extends Service
{
     ...
     */
    public $exceptUrl = [
        '/api/v1/member/person/check',
        '/api/v1/sys/notify-message/system',
        '/api/v1/api/record/input',
        '/api/v1/api/record/output',
        '/api/v1/api/xhs/get-recruit-blog',
        '/api/v1/api/xhs/sumbit-blog-note',
        '/api/v1/api/xhs/get-article-list',
    ];
    ...
    public function record($response, $showReqId = false)
    {
        ...
        if (in_array($url[0], $this->exceptUrl)) {
            return $this->errData;
        }
